...
if status is-interactive
    ...
    alias lsh="ls --group-directories-first --color=auto -1Ahlv --time-style=long-iso"
    ...
    if test $(uname) = "Darwin"
        ...
        alias lsh="$(command -v gls) --group-directories-first --color=auto -1Ahlv --time-style=long-iso"
